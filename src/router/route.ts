		...
		children: [
			{
				...
				children: [
					...
					// {
					// 	path: '/sys/book/featuretag',
					// 	name: 'sysbookfeaturetag',
					// 	component: () => import('/@/views/sys/book/Featuretag.vue'),
					// 	meta: {
					// 		title: '特色标签',
					// 		isLink: '',
					// 		isHide: false,
					...
					// },
					// {
					// 	path: '/sys/book/series',
					// 	name: 'sysbookseries',
					// 	component: () => import('/@/views/sys/book/Series.vue'),
					// 	meta: {
					// 		title: '系列分类',
					// 		isLink: '',
					// 		isHide: false,
					...
					// },
					{
						path: '/sys/book/character',
						name: 'sysbookcharacter',
						component: () => import('/@/views/sys/book/Character.vue'),
						meta: {
							title: '特色人物',
							isLink: '',
							isHide: false,
					...
					},
					{
						path: '/sys/book/brand',
						name: 'sysbookbrand',
						component: () => import('/@/views/sys/book/Brand.vue'),
						meta: {
							title: '知名品牌',
							isLink: '',
							isHide: false,
					...
					// {
					// 	path: '/sys/book/warehouse',
					// 	name: 'sysbookwarehouse',
					// 	component: () => import('/@/views/sys/book/Warehouse.vue'),
					// 	meta: {
					// 		title: '书籍仓库',
					// 		isLink: '',
					// 		isHide: false,
			...
			},
			{
				...
				children: [
					...
					// 	path: '/sys/xcx/theme',
					// 	name: 'sysxcxtheme',
					// 	component: () => import('/@/views/sys/xcx/Theme.vue'),
					// 	meta: {
					// 		title: '主题推荐',
					// 		isLink: '',
					// 		isHide: false,
					...
					// 	path: '/sys/xcx/brand',
					// 	name: 'sysxcxbrand',
					// 	component: () => import('/@/views/sys/xcx/Brand.vue'),
					// 	meta: {
					// 		title: '品牌专区',
					// 		isLink: '',
					// 		isHide: false,
					...
					// },
					// {
					// 	path: '/sys/xcx/character',
					// 	name: 'sysxcxcharacter',
					// 	component: () => import('/@/views/sys/xcx/Character.vue'),
					// 	meta: {
					// 		title: '特色人物',
					// 		isLink: '',
					// 		isHide: false,
